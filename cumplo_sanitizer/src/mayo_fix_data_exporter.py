...
fix_data = [
    # ==> (cumplo earnings) 513363 - (calculated earnings) 477954
    ["27555", "avanza construccion ltda", "2016-Sep-05", (513363 - 477954), 0],
    ...
    # >> not executed & 'not returned' on records
    ["29597", "hurtado bombeo de hormigon", "2016-12-22", (503075), 0],
    ...
    # >> super weird, $500k not returned?)
    ["33765", "viveros chile", "2018-06-25", ((504000 + 404000) - 408132), 0],
    ...
    [
        "66010",
        "vibrados y construcciones carlos novoa espinoza eirl",
        "2023-01-25",
        (514500 * 2 - 0),
        0,
    ],
    ["66019", "Comercial 2050", "2023-01-19", (506558 * 2 - 689021), 0],
    ["66815", "MULTI SAFE", "2023-02-10", 79130, 0],
...
with open(csv_filename, "w", newline="") as csv_file:
    ...
    csv_writer.writerow(["RemateID", "Actor", "Date_YYYY-MM-DD", "Abono", "Cargo"])
